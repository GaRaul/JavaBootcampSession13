CREATE DATABASE  IF NOT EXISTS `estaciones` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `estaciones`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: 192.168.1.154    Database: estaciones
-- ------------------------------------------------------
...
CREATE TABLE `estacion` (
  ...
  `latitud` int DEFAULT '1000',
  `longitud` int DEFAULT '1000',
  `altitud` int DEFAULT '1000',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-01-28 12:45:56
